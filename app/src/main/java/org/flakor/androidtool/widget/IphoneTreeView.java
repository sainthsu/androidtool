        ...
        AbsListView.OnScrollListener, ExpandableListView.OnGroupClickListener
{
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        int state = getTreeHeaderState(groupPos, childPos);
    ...
    public void configureHeaderView(int groupPosition, int childPosition) {
        ...
        int state = getTreeHeaderState(groupPosition, childPosition);
    ...
    {
        final int childCount = ((BaseExpandableListAdapter)mAdapter).getChildrenCount(groupPosition);
        if (childPosition == childCount - 1)
        {
            return IphoneTreeHeaderAdapter.PINNED_HEADER_PUSHED_UP;
        }
        else if (childPosition == -1 && !isGroupExpanded(groupPosition))
        {
            return IphoneTreeHeaderAdapter.PINNED_HEADER_GONE;
        }
        else
        {
            return IphoneTreeHeaderAdapter.PINNED_HEADER_VISIBLE;
        }
    }
}
